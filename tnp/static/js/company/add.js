$(document).ready(function() {
    ...
    $('#cgpa_upto_semester')[0].innerHTML = 'CGPA Upto Semester <input type="hidden" value="cgpa_upto_semester" name="A"> <div class="input-field inline"> <input type="number" value="6" name="A" style="width: 30px; text-align: center;"> </div>';
    $('#cgpa_of_semester')[0].innerHTML = 'CGPA Of Semester <input type="hidden" value="cgpa_of_semester" name="C"> <div class="input-field inline"> <input type="number" value="6" name="C" style="width: 30px; text-align: center;"> </div>';
});
